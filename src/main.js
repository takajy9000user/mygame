...
const quizBank = [
  {
    ...
    answerIndex: 1,
    explanation: '旧石器時代には打製石器が使われていました。',
  },
  {
    era: '旧石器時代',
    card: '港川人',
    ...
    answerIndex: 1,
    explanation: '旧石器時代は狩りや採集で生活していました。',
  },
  {
    era: '縄文時代',
    card: '縄文人',
  ...
  },
  {
    ...
    answerIndex: 1,
    explanation: '縄文時代の住まいとして竪穴住居が有名です。',
  },
  {
    era: '弥生時代',
    card: '卑弥呼',
  ...
  },
  {
    ...
    answerIndex: 1,
    explanation: '仁徳天皇陵古墳は大きな前方後円墳として有名です。',
  },
  {
    era: '飛鳥時代',
    card: '聖徳太子',
    ...
    answerIndex: 0,
    explanation: '十七条の憲法を定めたのは聖徳太子です。',
  },
  {
    era: '飛鳥時代',
    card: '中大兄皇子',
    ...
    answerIndex: 1,
    explanation: '中大兄皇子たちが進めた改革は大化の改新です。',
  },
  {
    era: '奈良時代',
    card: '聖武天皇',
  ...
  },
  {
    ...
    answerIndex: 0,
    explanation: '後醍醐天皇が南北朝時代のはじまりに深く関わりました。',
  },
  {
    era: '南北朝時代',
    card: '足利尊氏',
  ...
  },
  {
    ...
    answerIndex: 1,
    explanation: '昭和時代には太平洋戦争が起こりました。',
  },
  {
    era: '昭和',
    card: '昭和天皇',
    ...
    answerIndex: 1,
    explanation: '東京オリンピックは昭和39年に開かれました。',
  },
  {
    era: '昭和',
    card: '昭和のくらし',
    ...
    answerIndex: 3,
    explanation: '三種の神器はテレビ・洗濯機・冷蔵庫です。',
  },
]
